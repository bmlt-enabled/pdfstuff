...
{
    // Declare properties to avoid dynamic properties in PHP 8.2+
    public $helpline_string;
    public $credits_string;
    public $web_uri_string;
    public $banner_1_string;
    public $banner_2_string;
    public $banner_3_string;
    public $week_starts_1_based_int;
    public $image_path_string;
    public $filename;
    public $root_uri;
    public $date_header_format_string;
    public $page_margins;
    public $list_page_sections;
    public $page_max;
    public $twofold;
    public $foursection;
    /********************************************************************
