...
class printableList {
	...
	*/
	...
	/********************************************************************
	*/
	function DrawListPage ( $left, $top, $right, $bottom, $margin, $columns )
	{
	...
	/********************************************************************
	*/
	function DrawWeekdayHeader ( $left, $top, $column_width, $weekday, $continued = FALSE )
	{
		$heading_height = 8;
		$height = 0.15;
	...
	/********************************************************************
	*/
	function DrawOneMeeting ( $left, $top, $column_width, $meeting )
	{
		$fontFamily = $this->napdf_instance->getFontFamily();
		$fontSize = $this->font_size - 1.5;
