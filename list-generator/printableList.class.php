...
class printableList {
	...
	var $weekday_names_short = array ("Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat");
	var $continued = "Continued";
	var $continued_short = "Cont'd";
	var $format_header = "FORMAT LEGEND";
	var	$pos = array ('start' => 1, 'end' => '', 'count' => 0, 'y' => 0, 'weekday' => 1);
	var $formats = 0;
	var $list_name_header = 'Name';
	var $list_number_header = 'Phone #';
	var $variable_font_size = NULL;
	...
	*/
	function DrawFormats ( $left,
        ...
        $sorter = function ($a, $b) { return ($a['key_string'] < $b['key_string']) ? -1 : (($a['key_string'] > $b['key_string']) ? 1 : 0); };
        ...
        $fill_color = isset($this->format_header_fill_color) ? $this->format_header_fill_color : 0;
        $text_color = isset($this->format_header_text_color) ? $this->format_header_text_color : 255;
	...
	*/
	...
	/********************************************************************
	*/
	function DrawWeekdayHeader (   $left,
	                                $top,
	                                $column_width,
	                                $weekday,
	                                $continued = FALSE
        ...
        $fill_color = isset($this->weekday_header_fill_color) ? $this->weekday_header_fill_color : 0;
        $text_color = isset($this->weekday_header_text_color) ? $this->weekday_header_text_color : 255;
